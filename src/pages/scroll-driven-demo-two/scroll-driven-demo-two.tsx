  ...
  return (
    <>
      <div
        ...
        style={{ timelineScope: "--scroller, --slide-1, --slide-2, --slide-3" }}
      >
        <div
        ...
        <main className="lg:max-h-[1000px] hidden supports-sda:flex flex-1 py-14 lg:pb-9 relative flex-col">
          <div className="max-lg:relative lg:contents">
            ...
            <div
              className="lg:absolute -z-10 inset-0 h-full w-full overflow-x-auto snap-mandatory scroll-smooth snap-x scrollbar-hidden pointer-events-auto"
              style={{ scrollTimeline: "--scroller x" }}
            >
              <div className="grid grid-flow-col auto-cols-[50cqw] px-[25cqw] lg:h-full w-fit">
                <div
                  className="snap-center overflow-hidden max-lg:pb-[3rem] flex items-center justify-center"
                  style={{
                    viewTimeline: "--slide-1 x",
                    viewTimelineInset: "25cqw",
                  }}
                >
                  <img
                    className="animate-bottle lg:h-4/5 object-contain"
                    style={{ animationTimeline: "--slide-1" }}
                    src={abyss}
          ...
          <div className="px-7 max-lg:mt-10 flex flex-col items-center lg:items-start flex-1 max-lg:text-center lg:w-[29rem]">
            <h2 className="uppercase font-semibold tracking-widest mb-6 whitespace-nowrap">
              Closca Bottle Wave
            </h2>
            <div className="overlap flex-1 max-lg:items-start max-lg:justify-center max-lg:max-w-[36rem] lg:max-xl:max-w-[25cqw]">
                ...
                >
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M18.5303 0.469727L23.5607 5.50006L18.5303 10.5304L17.4697 9.46973L20.6893 6.25006H0.5V4.75006H20.6893L17.4697 1.53039L18.5303 0.469727Z"
                      fill="currentColor"
                    />
                  </svg>
                </a>
              ...
              <div className="flex flex-col items-center lg:items-start">
                ...
                >
                  ...
                  and only 9% of them will have a second life.
                </p>
                <a
                  href="https://closca.com"
                  className="animate-text group pointer-events-auto inline-flex gap-4 items-center !text-current mt-6"
      ...
      <div className="container mx-auto my-20 flex flex-col items-center">
        <h1 className="text-4xl max-md:text-xl text-center font-bold pb-3">
          ...
          <Link
            target="_blank"
            to="https://tympanus.net/Development/ScrollCarousel/index2.html"
          >
            Demo
          </Link>
        </h1>
